...
public interface TimeslotRepository extends ListCrudRepository<Timeslot, Integer> {
    ...
    @Query("SELECT t.id, t.start_time, t.end_time, b.day FROM Timeslot t LEFT JOIN Band b ON b.timeslot_id = t.id WHERE b.timeslot_id IS NULL")
    List<Object[]> listAvailableSlots();
}